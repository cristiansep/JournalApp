    ...
    const isFormValid = () => {
      ...
      if(name.trim().length === 0) {
        ...
        return false;
          ...
          dispatch(setError('Password should be at least 3 characters and match each other '));
          Swal.fire('Error', 'Password should be at least 3 characters and match each other ', 'error');
        return false;
      }
